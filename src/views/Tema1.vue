    ...
    .container.tarjeta.tarjeta--blanca.p-4.p-md-5.mb-5
      ...
      .bg_img_1
        .row.justify-content-center.align-items-center
          ...
          .col-lg-7.mb-5
            ...
            p.mb-3 Las frutas y verduras son alimentos esenciales que proporcionan numerosos beneficios para nuestra salud. Son ricas en vitaminas, minerales, fibra y antioxidantes que ayudan a mantener un cuerpo sano y a prevenir enfermedades.
            p.mb-3 Su alto contenido de fibra mejora la digestión, regula los niveles de colesterol y previene el estreñimiento. Las frutas y verduras también son bajas en calorías y ricas en agua, lo que las convierte en una opción ideal para controlar el peso y mantener una buena hidratación. 
      ...
      .row.justify-content-center.align-items-center.mb-0
        .tarjeta--container.mb-2.row.justify-content-center.align-items-center.ordenar_tarjeta_lg
          ...
          .col-md-12.col-lg-8.col-xl-5.tarjeta.bg-04.p-5.mb-5
            ...
            p.mb-2 Aunque algunas frutas como los tomates, los pepinos o las calabazas se consumen como verduras, en realidad son frutos que se han adaptado para ser utilizados en platos salados. 
  
          .col-md-5.col-lg-4.col-xl-3.tarjeta.mb-5.pos_2
      ...
      .row.justify-content-center.align-items-center.mb-4
        .col-lg-12.mb-4
          .bloque-texto-g.bloque-texto-g.bg-09.p-3.p-sm-4.p-md-5
            ...
            .bloque-texto-g__texto.p-4.mb-3
